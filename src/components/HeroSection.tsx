        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              Mới 2025 - Camera AI thông minh
            </motion.div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6">
              <span className="text-gray-900 dark:text-white">PETKIT</span>
              <br />
              <span className="gradient-text">PUROBOT ULTRA</span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-lg">
              Máy dọn phân mèo tự động với Camera AI xoay 180°,
              đàm thoại 2 chiều, phân tích sức khỏe và 20 cảm biến an toàn.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              {[
                { value: '20', label: 'Cảm biến' },
                { value: '70L', label: 'Dung tích' },
                { value: '180°', label: 'Camera xoay' },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
                  initial={{ opacity: 0, y: 20 }}
